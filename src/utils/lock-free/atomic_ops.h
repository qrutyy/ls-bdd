 ...
 * atomic_* versions of cmpxchg or other actions are used for better cross-architecture work. Btw, they provide more memory order guarantees and type safety.
 */
